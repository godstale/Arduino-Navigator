...
public class FragmentAdapter extends FragmentPagerAdapter {
    ...
    public static final int FRAGMENT_POS_GMAP = 0;
    ...
    private SupportMapFragment mGMapFragment = null;
	...
	public Fragment getItem(int position) {
		...
		if(position == FRAGMENT_POS_GMAP) {
			if(mGMapFragment == null) {
				mGMapFragment = new SupportMapFragment() {
					@Override
					public void onActivityCreated(Bundle savedInstanceState) {
						// Only after fragment initialization you can get map instance.
						// So do the map control after this line.
						super.onActivityCreated(savedInstanceState);
						if (this.getMap() != null) {
							mFragmentListener.OnFragmentCallback(IFragmentListener.CALLBACK_MAP_CREATED, 
									this.getView().getWidth(), this.getView().getHeight(), null, null, 
									this.getMap() );
						}
					}
				};
			}
			fragment = mGMapFragment;
